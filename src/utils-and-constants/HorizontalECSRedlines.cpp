...
extern const std::vector<const IRedline *> ONLINE_SAFE_D = {
        new ValveRedline("loxVent in ONLINE_SAFE_D", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in ONLINE_SAFE_D", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in ONLINE_SAFE_D", [](const SensorData *data) { return data->loxDrip; }, OPEN),
        new ValveRedline("kerDrip in ONLINE_SAFE_D", [](const SensorData *data) { return data->kerDrip; }, OPEN),
        ...
        new ValveRedline("kerPressurant in ONLINE_SAFE_D", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in ONLINE_SAFE_D", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in ONLINE_SAFE_D", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in ONLINE_SAFE_D", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in ONLINE_SAFE_D", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> KERO_FILL = {
        new ValveRedline("loxVent in KERO_FILL", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in KERO_FILL", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in KERO_FILL", [](const SensorData *data) { return data->loxDrip; }, OPEN),
        new ValveRedline("kerDrip in KERO_FILL", [](const SensorData *data) { return data->kerDrip; }, OPEN),
        ...
        new ValveRedline("kerPressurant in KERO_FILL", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in KERO_FILL", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in KERO_FILL", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in KERO_FILL", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in KERO_FILL", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> KERO_FILLED = {
        new ValveRedline("loxVent in KERO_FILLED", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in KERO_FILLED", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in KERO_FILLED", [](const SensorData *data) { return data->loxDrip; }, OPEN),
        new ValveRedline("kerDrip in KERO_FILLED", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in KERO_FILLED", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in KERO_FILLED", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in KERO_FILLED", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in KERO_FILLED", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in KERO_FILLED", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> LOX_FILL = {
        new ValveRedline("loxVent in LOX_FILL", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in LOX_FILL", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in LOX_FILL", [](const SensorData *data) { return data->loxDrip; }, OPEN),
        new ValveRedline("kerDrip in LOX_FILL", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in LOX_FILL", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in LOX_FILL", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in LOX_FILL", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in LOX_FILL", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in LOX_FILL", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> LOX_FILLED = {
        new ValveRedline("loxVent in LOX_FILLED", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in LOX_FILLED", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in LOX_FILLED", [](const SensorData *data) { return data->loxDrip; }, CLOSED),
        new ValveRedline("kerDrip in LOX_FILLED", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in LOX_FILLED", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in LOX_FILLED", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in LOX_FILLED", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in LOX_FILLED", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in LOX_FILLED", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> ONLINE_SAFE = {
        new ValveRedline("loxVent in ONLINE_SAFE", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in ONLINE_SAFE", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in ONLINE_SAFE", [](const SensorData *data) { return data->loxDrip; }, CLOSED),
        new ValveRedline("kerDrip in ONLINE_SAFE", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in ONLINE_SAFE", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in ONLINE_SAFE", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in ONLINE_SAFE", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in ONLINE_SAFE", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in ONLINE_SAFE", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> READY_TO_PRESSURIZE = {
        ...
        new ValveRedline("loxPressurant in READY_TO_PRESSURIZE",
                         [](const SensorData *data) { return data->loxPressurant; }, CLOSED),
        new ValveRedline("kerPressurant in READY_TO_PRESSURIZE",
                         [](const SensorData *data) { return data->kerPressurant; }, CLOSED),
...
extern const std::vector<const IRedline *> PRESSURIZING = {
        new ValveRedline("loxVent in PRESSURIZING", [](const SensorData *data) { return data->loxVent; }, CLOSED),
        new ValveRedline("kerVent in PRESSURIZING", [](const SensorData *data) { return data->kerVent; }, CLOSED),
        new ValveRedline("loxDrip in PRESSURIZING", [](const SensorData *data) { return data->loxDrip; }, CLOSED),
        new ValveRedline("kerDrip in PRESSURIZING", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in PRESSURIZING", [](const SensorData *data) { return data->kerPressurant; },
                         OPEN),
        new ValveRedline("loxFlow in PRESSURIZING", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in PRESSURIZING", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in PRESSURIZING", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in PRESSURIZING", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> FIRE = {
        new ValveRedline("loxVent in FIRE", [](const SensorData *data) { return data->loxVent; }, CLOSED),
        new ValveRedline("kerVent in FIRE", [](const SensorData *data) { return data->kerVent; }, CLOSED),
        new ValveRedline("loxDrip in FIRE", [](const SensorData *data) { return data->loxDrip; }, CLOSED),
        new ValveRedline("kerDrip in FIRE", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        new ValveRedline("loxPressurant in FIRE", [](const SensorData *data) { return data->loxPressurant; }, OPEN),
        new ValveRedline("kerPressurant in FIRE", [](const SensorData *data) { return data->kerPressurant; }, OPEN),
        new ValveRedline("loxFlow in FIRE", [](const SensorData *data) { return data->loxFlow; }, OPEN),
        new ValveRedline("kerFlow in FIRE", [](const SensorData *data) { return data->kerFlow; }, OPEN),
        new ValveRedline("loxPurge in FIRE", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in FIRE", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
...
extern const std::vector<const IRedline *> ENGINE_PURGE = {
        new ValveRedline("loxVent in ENGINE_PURGE", [](const SensorData *data) { return data->loxVent; }, CLOSED),
        new ValveRedline("kerVent in ENGINE_PURGE", [](const SensorData *data) { return data->kerVent; }, CLOSED),
        new ValveRedline("loxDrip in ENGINE_PURGE", [](const SensorData *data) { return data->loxDrip; }, CLOSED),
        new ValveRedline("kerDrip in ENGINE_PURGE", [](const SensorData *data) { return data->kerDrip; }, CLOSED),
        ...
        new ValveRedline("kerPressurant in ENGINE_PURGE", [](const SensorData *data) { return data->kerPressurant; },
                         CLOSED),
        new ValveRedline("loxFlow in ENGINE_PURGE", [](const SensorData *data) { return data->loxFlow; }, CLOSED),
        new ValveRedline("kerFlow in ENGINE_PURGE", [](const SensorData *data) { return data->kerFlow; }, CLOSED),
        new ValveRedline("loxPurge in ENGINE_PURGE", [](const SensorData *data) { return data->loxPurge; }, OPEN),
        new ValveRedline("kerPurge in ENGINE_PURGE", [](const SensorData *data) { return data->kerPurge; }, OPEN),
...
extern const std::vector<const IRedline *> TANK_PURGE = {
        new ValveRedline("loxVent in TANK_PURGE", [](const SensorData *data) { return data->loxVent; }, OPEN),
        new ValveRedline("kerVent in TANK_PURGE", [](const SensorData *data) { return data->kerVent; }, OPEN),
        new ValveRedline("loxDrip in TANK_PURGE", [](const SensorData *data) { return data->loxDrip; }, OPEN),
        new ValveRedline("kerDrip in TANK_PURGE", [](const SensorData *data) { return data->kerDrip; }, OPEN),
        ...
        new ValveRedline("kerPressurant in TANK_PURGE", [](const SensorData *data) { return data->kerPressurant; },
                         OPEN),
        new ValveRedline("loxFlow in TANK_PURGE", [](const SensorData *data) { return data->loxFlow; }, OPEN),
        new ValveRedline("kerFlow in TANK_PURGE", [](const SensorData *data) { return data->kerFlow; }, OPEN),
        new ValveRedline("loxPurge in TANK_PURGE", [](const SensorData *data) { return data->loxPurge; }, CLOSED),
        new ValveRedline("kerPurge in TANK_PURGE", [](const SensorData *data) { return data->kerPurge; }, CLOSED),
