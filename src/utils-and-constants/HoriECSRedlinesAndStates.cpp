...
extern std::vector<IRedline *> FIRE_REDLINES = {
        ...
        new ValveRedline("loxPressurant in FIRE", loxPressurantSelector, ECSValveState::OPEN),
        new ValveRedline("kerPressurant in FIRE", kerPressurantSelector, ECSValveState::OPEN),
